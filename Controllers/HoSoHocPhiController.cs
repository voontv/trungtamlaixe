namespace Ttlaixe.Controllers
{
    ...
    public class HoSoHocPhiController : ControllerBase
    {
        ...
        [HttpGet("danh-sach-hoc-phi-khoa-hoc")]
        ...
        public async Task<List<HoSoHocPhiResponse>> GetAllByMaKhoaHocs([FromBody] List<string> maKhoaHocs)
        {
        ...
        //public async Task<List<HoSoHocPhiResponse>> GetChuaHoanThanh()
        //{
        //    return await _business.GetChuaHoanThanhAsync();
        //}
        ...
        [Authorize]
        [HttpPost]
        public async Task<HoSoHocPhi> Create([FromBody] HoSoHocPhiCreated model)
        {
        ...
        [Authorize]
        [HttpPut("{maDK}")]
        public async Task<bool> Update(string maDK, [FromBody] HoSoHocPhiUpdate model)
        {
